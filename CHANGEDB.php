...
$count++;
$sql[$count][0] = "1.2.00";
$sql[$count][1] = "CREATE TABLE IF NOT EXISTS `gibbonFinanceMgmtPaymentPlan` (
...
SELECT 'FinanceCustom', 'installmentInitialDeposit', 'Required Initial Deposit', 'Configured initial deposit amount required when choosing installment plans.', '0', 'number'
FROM DUAL
WHERE NOT EXISTS (
