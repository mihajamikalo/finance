...
$moduleTables[] = "CREATE TABLE IF NOT EXISTS `gibbonFinanceMgmtStudentPayment` (
  ...
  `paymentMethod` enum('BANK','MOBILE','CASH','OTHER') NOT NULL DEFAULT 'CASH',
...
$moduleTables[] = "CREATE TABLE IF NOT EXISTS `gibbonFinanceMgmtPaymentPlan` (
  ...
  `tuitionFeeEuro`      decimal(14,2)    DEFAULT NULL
...
$actionRows[] = [
    ...
    'URLList'                   => 'payments_add.php,payments_addProcess.php,ajax_studentSearch.php,ajax_checkStudentPlan.php,receipt_print.php',
